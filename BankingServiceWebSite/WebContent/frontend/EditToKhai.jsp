	...
	<form name="khaibao" action="doEditKhaiBao.jsp" method="post"
		...
		<div class="container">
			...
			<label for="Nghenghiep"><b>Nghề nghiệp </b><a
				style="color: red;">(*)</a></label> <input value="<%=tk.get(0).getNghenghiep() %>" type="text" name="Nghenghiep"
				id="Nghenghiep" required> <label for="Nghenghiep"><b>Chức
					vụ </b><a style="color: red;">(*)</a></label> <input value="<%=tk.get(0).getChucvu() %>" type="text" name="Chucvu"
				id="Chucvu" required> <label for="Nghenghiep"><b>Tên
					công ty </b><a style="color: red;">(*)</a></label> <input value="<%=tk.get(0).getTencongty() %>" type="text"
				name="Tencongty" id="Tencongty" required> 
				<label for="Diachicongty"><b>Địa chỉ công ty </b><astyle="color: red;">(*)</a>
				</label> 
				<input type="text" value="<%=tk.get(0).getDiachicongty() %>" name="Diachicongty"id="Diachicongty" required>
			<div>
