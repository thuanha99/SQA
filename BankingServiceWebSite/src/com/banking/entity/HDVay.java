...
public class HDVay {
    ...
    public HDVay(int id, int goivayID, int userID, Date Ngayvay, String kiHan, String Trangthai, float TienVay, int tokhaiID) {
        this.id = id;
        this.goivayID = goivayID;
        this.userID = userID;
        this.Ngayvay = Ngayvay;
    ...
    public String toString() {
        return "HDVay{" + "id=" + id + ", goivayID=" + goivayID + ", userID=" + userID + ", Ngayvay=" + Ngayvay + ", kiHan=" + kiHan + ", Trangthai=" + Trangthai + ", TienVay=" + TienVay+ ", tokhaiID=" + tokhaiID + '}';
    }
